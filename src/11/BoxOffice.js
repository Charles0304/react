    ...
    return (
        <div className="w-full flex flex-col 
            ...
            <div className="w-4/5 flex justify-end items-center">
                ...
                <TailInput type="date" inputRef={boxRef} handleChange={handleSelData} ph="" />
            </div>
            ...
            <div className="w-4/5 h-12 flex justify-center items-center text-bold text-center bg-gray-500 text-white p-5">
